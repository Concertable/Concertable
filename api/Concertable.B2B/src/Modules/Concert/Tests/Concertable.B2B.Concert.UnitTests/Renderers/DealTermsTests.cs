...
public sealed class DealTermsTests : IDisposable
{
    ...
    public static TheoryData<IDealTerms, string, string, string> Characterizations =>
        new()
        {
        {
            new FlatFeeTerms { PaymentMethod = PaymentMethod.Transfer, Fee = 500m },
            "The venue pays the artist a flat fee of £500.00.",
            "Fee=500",
            "B360CD844AEAEC445D368309962F18A1EA0DACA28173D69D98F036798A92B91B"
        },
        {
            new DoorSplitTerms { PaymentMethod = PaymentMethod.Cash, ArtistDoorPercent = 70m },
        ...
        {
            new VersusTerms { PaymentMethod = PaymentMethod.Cash, Guarantee = 200m, ArtistDoorPercent = 62.5m },
        ...
        {
            new VenueHireTerms { PaymentMethod = PaymentMethod.Transfer, HireFee = 300m },
    ...
    {
        var result = renderer.Render(terms);
    ...
    public void Serialize_DealType_ReturnsPinnedCanonicalValue(
        ...
        string expectedFingerprint)
    {
        var result = serializer.Serialize(terms);
    ...
    public void Calculate_DealType_ReturnsPinnedFingerprint(
        ...
        string expectedFingerprint)
    {
        var result = fingerprint.Calculate(terms, Period);
