...
- [ ] 🟢 **Manager front-page dashboards.** `launch/manager-front-page` Venue and artist manager workbenches, real-data wiring, and authenticated responsive acceptance are complete; review, delivery, platform sync, and closeout are owned by [MANAGER_FRONT_PAGE_PLAN.md](MANAGER_FRONT_PAGE_PLAN.md).
