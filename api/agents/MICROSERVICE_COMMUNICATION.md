...
> **Companion to** [MICROSERVICES_ARCHITECTURE.md](../docs/MICROSERVICES_ARCHITECTURE.md) and [MICROSERVICE_STEPS.md](../../plans/platform/MICROSERVICE_STEPS_PLAN.md).
...
| Event-driven / fire-and-forget | **Azure Service Bus** | Already the seam — see [MICROSERVICE_STEPS.md](../../plans/platform/MICROSERVICE_STEPS_PLAN.md) Steps 8–10 |
