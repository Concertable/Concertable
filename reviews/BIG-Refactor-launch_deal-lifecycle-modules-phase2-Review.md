...
- [~] **NAT10 — HIGH — correctness / transactionality** — `api/Concertable.B2B/src/Modules/Booking/Concertable.B2B.Booking.Infrastructure/Events/AcceptanceFinancialOperationOutcomeProcessor.cs:123`
...
- [ ] **NAT11 — HIGH — correctness / concurrency** — `api/Concertable.B2B/src/Modules/Booking/Concertable.B2B.Booking.Infrastructure/Events/VerifyPaymentSucceededHandler.cs:20`
