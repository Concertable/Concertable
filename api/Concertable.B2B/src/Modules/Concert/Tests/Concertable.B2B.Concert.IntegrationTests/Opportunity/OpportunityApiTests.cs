...
public sealed class OpportunityApiTests : IAsyncLifetime
{
    ...
    public static TheoryData<IDealTerms> AllDealTypes =>
    [
        new FlatFeeTerms { PaymentMethod = PaymentMethod.Cash, Fee = 500 },
        new DoorSplitTerms { PaymentMethod = PaymentMethod.Cash, ArtistDoorPercent = 70 },
        new VersusTerms { PaymentMethod = PaymentMethod.Cash, Guarantee = 200, ArtistDoorPercent = 60 },
        new VenueHireTerms { PaymentMethod = PaymentMethod.Cash, HireFee = 300 },
    ];
    ...
    public async Task Create_ShouldReturnCreatedOpportunity(IDealTerms terms)
    {
        // Arrange
    ...
    {
        var client = fixture.CreateClient(fixture.SeedState.VenueManager1);
        var request = BuildRequest(new VersusTerms
        {
    ...
    {
        var client = fixture.CreateClient(fixture.SeedState.VenueManager1);
        var request = BuildRequest(new VenueHireTerms
        {
            PaymentMethod = PaymentMethod.Cash,
            HireFee = 0
