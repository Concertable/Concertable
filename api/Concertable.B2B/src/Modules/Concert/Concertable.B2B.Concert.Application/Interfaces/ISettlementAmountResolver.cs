...
/// <see cref="IDealTerms.DealType"/>: the fixed fee for FlatFee/VenueHire, the venue-declared revenue share for
...
{
    Task<Money> ResolveGrossAsync(int concertId, IDealTerms terms, CancellationToken ct = default);
}
