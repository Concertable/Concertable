...
public sealed class DoorSplitTermsEntityTests
{
    [Theory]
    [InlineData(-1)]
    [InlineData(101)]
    ...
    {
        var result = DoorSplitTermsEntity.Create(artistDoorPercent, PaymentMethod.Cash);
    ...
    {
        var creation = DoorSplitTermsEntity.Create(artistDoorPercent, PaymentMethod.Cash);
    ...
    {
        var creation = DoorSplitTermsEntity.Create(25m, PaymentMethod.Cash);
        Assert.True(creation.TryGetValue(out var deal));
