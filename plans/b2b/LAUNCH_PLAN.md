...
- [ ] 🟠 **Percentage commission + B2B pricing transparency** — replace the temporary £10 fee before launch. B2B calculates the final payee gross through four deal strategies; Payment stores each immutable percentage revision once, binds it to payer commitments through authorization records, and charges gross plus commission. Implement exact/formula disclosure, deferred-gross review and durable refund/tax/ledger facts. See [PLATFORM_COMMISSION.md](PLATFORM_COMMISSION.md).
