...
Re-assert auto-merge once for PR #536 at exact reviewed/current-main head `7a0886e12` with
`full-e2e`, then verify queue admission. Wait for its merge, package publication, and
