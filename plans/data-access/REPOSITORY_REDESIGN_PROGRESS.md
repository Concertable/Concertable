...
- **Merge-queue E2E tier is `full-e2e`.** The DataAccess public package shape is renamed, which is a positive trigger under the merge skill even though the earlier ledger snapshot said `skip-e2e`.
