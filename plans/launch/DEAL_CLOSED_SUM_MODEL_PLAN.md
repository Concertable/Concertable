...
- Implement the fixed paid/simple acceptance union and the approved confirmation/completion operation
  unions from the landed module APIs.
- Delete provisional executor/step factories; do not route their heterogeneous cases through the
