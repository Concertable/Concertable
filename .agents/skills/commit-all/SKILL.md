...
- **No AI-attribution trailer** — never add `Co-Authored-By: Codex`, `Generated with Codex`, or similar.
...
- machine-local agent/editor state (e.g. tracked `.Codex/worktrees/` gitlink churn).
