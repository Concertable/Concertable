...
public sealed class VersusTermsEntityTests
{
    [Fact]
    public void Create_NegativeGuarantee_ReturnsFailure()
    {
        var result = VersusTermsEntity.Create(-1m, 50m, PaymentMethod.Cash);
    ...
    {
        var result = VersusTermsEntity.Create(100m, artistDoorPercent, PaymentMethod.Cash);
    ...
    {
        var creation = VersusTermsEntity.Create(100m, 25m, PaymentMethod.Cash);
