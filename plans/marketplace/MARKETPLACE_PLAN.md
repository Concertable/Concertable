...
> **Updated:** 2026-05-18
>
> **Companion docs:** [LAUNCH_ROADMAP.md](../launch/LAUNCH_ROADMAP.md), [LAUNCH_CHECKLIST.md](../launch/LAUNCH_CHECKLIST.md), [USER_MODEL_PLAN.md](../b2b/USER_MODEL_PLAN.md).
...
- [LAUNCH_ROADMAP.md](../launch/LAUNCH_ROADMAP.md) §8 — high-level marketplace mention
- [LAUNCH_CHECKLIST.md](../launch/LAUNCH_CHECKLIST.md) "Deferred — Phase 2" section — the items it explicitly defers
