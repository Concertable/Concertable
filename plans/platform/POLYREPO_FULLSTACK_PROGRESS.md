...
- Last reconciled: 2026-08-05 (resume) — Phase 2 fully terminal (merged + published); Phase 3a committed on-branch, unpushed; branch drifted to **19 behind `origin/main`** — re-sync before opening the Phase 3a PR.
